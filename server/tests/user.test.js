...
const app = require('../app'); // Adjust the path to your app   instance
const User = require('../models/user.model');
const { setupDatabase, teardownDatabase, connectDB } = require('./setup');
...
afterEach(async () => {
  // Optionally, you can clear the database after each test
  const collections = mongoose.connection.collections;
  for (const key in collections) {
    await collections[key].deleteMany({});
  }
